            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      className={`rounded-full px-2.5 py-1 text-[11px] font-medium ${company.maintenanceMode
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-3 text-sm font-medium transition ${company.maintenanceMode
